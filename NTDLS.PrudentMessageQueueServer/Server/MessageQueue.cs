...
namespace NTDLS.PrudentMessageQueue.Server
{
    ...
    /// </summary>
    internal class MessageQueue(PMqServer mqServer, PMqQueueConfiguration queueConfiguration)
    {
        ...
        /// </summary>
        internal PessimisticCriticalResource<Dictionary<Guid, PMqSubscriberInformation>> Subscribers { get; set; } = new();
        ...
        private PMqServer QueueServer = mqServer;

        public PMqQueueConfiguration QueueConfiguration { get; private set; } = queueConfiguration;
        ...
        internal void SetServer(PMqServer mqServer)
        {
        ...
        private static void DeliveryThreadProc(object? pMessageQueue)
        {
            ...
            while (messageQueue.KeepRunning)
            {
                ...
                try
                {
                    ...
                    List<PMqSubscriberInformation>? yetToBeDeliveredSubscribers = null;
