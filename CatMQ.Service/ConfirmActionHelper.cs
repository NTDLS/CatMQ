...
namespace CatMQ.Service
{
    public static class ConfirmActionHelper
    {
        ...
        /// </summary>
        public static string GenerateDangerLink(string message, string linkLabel, string postBackTo, string aspHandler)
        {
            ...
            param.Append($"&AspHandler={Uri.EscapeDataString(aspHandler)}");
        ...
        /// </summary>
        public static string GenerateSafeLink(string message, string linkLabel, string postBackTo, string aspHandler)
        {
            var param = new StringBuilder();
            param.Append($"PostBackTo={Uri.EscapeDataString($"{postBackTo}")}");
            param.Append($"&Message={Uri.EscapeDataString(message)}");
        ...
        /// </summary>
        public static string GenerateWarnLink(string message, string linkLabel, string postBackTo, string aspHandler)
        {
            var param = new StringBuilder();
            param.Append($"PostBackTo={Uri.EscapeDataString($"{postBackTo}")}");
            param.Append($"&Message={Uri.EscapeDataString(message)}");
